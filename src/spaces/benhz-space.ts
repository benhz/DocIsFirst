...
export const benhzSpace = {
  ...
  moments: [
    {
      emoji: '💭',
      content: '突然想到可以用装饰器模式重构那坨屎山代码，明天就试试！',
      date: '2024.12.07',
    },
    {
      emoji: '😤',
      content: '产品经理又改需求了，下次别再说「这是最后一次改了」好吗？',
      date: '2024.12.05',
    },
    {
      emoji: '🎉',
      content: '今天的 Code Review 一次通过，开心！',
      date: '2024.12.03',
    },
  ],
  ...
  customCards: [
    ...
    },
    {
      title: '想说的话',
      emoji: '💬',
      content: '写代码不只是完成功能，更是一种艺术创作。每一行代码都应该优雅、简洁、可读。',
      color: 'linear-gradient(135deg, rgba(54, 162, 235, 0.1), rgba(75, 192, 192, 0.05))',
    },
  ],
};
